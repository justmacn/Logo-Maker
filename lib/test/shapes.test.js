...
describe('Shapes', () => {
    ...
    // a test to check square logo is constructing proper xml
    describe('Square', () => {
        it('should convert square input to <rect>', () => {
            const cir = new Square('SMP', 'green', 'square', 'peach')

            const result = cir.xml;

            const check = `<rect x="10" y="10" width="150" height="150"`
